<template>
  <div class="recentlyContainer">
    ...
    <div v-else class="recentlyContent">
      <el-container>
        <el-header class="recentlyHeader">
          近期新作
        </el-header>
          <el-main class="recentlyMain">
            <div class="MainContent">
              <SearchCard v-for="recentlyItem in recentlyItems" :key="recentlyItem.id"
              :id='recentlyItem.id'
